...
- NRPN edits (CC99=0/CC98/CC6 = value+64, **param 21 raw**); mod matrix via
  sysex; bank select + unlock; Program Change; store edit buffer; `E` pulls
  the edit buffer (dump parser ported from the VST) into the GUI.
